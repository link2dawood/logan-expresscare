...
<head>
    ...
    <meta name="description" content="Logan Express Care - User Management">
    <meta name="keywords" content="admin, users, management, logan express care">
    <meta name="author" content="Logan Express Care">
    <!-- Page Title -->
    <title>User Management - Logan Express Care</title>
    <!-- Favicon Icon -->
                                ...
                                <tbody>
                                    <?php foreach ($users as $userData): ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars(ucwords(str_replace('_', ' ', $userData['position']))); ?></td>
                                            <td><?php echo htmlspecialchars(ucfirst($userData['employment_type'])); ?></td>
                                            <td>
                                                <span class="status-badge status-<?php echo $userData['status']; ?>">
                                                    <?php echo ucfirst(str_replace('_', ' ', $userData['status'])); ?>
                                                </span>
                                            </td>
                                            <td><?php echo date('M j, Y', strtotime($userData['created_at'])); ?></td>
                                            <td>
                                                <?php echo $userData['reviewed_at'] ? date('M j, Y', strtotime($userData['reviewed_at'])) : '-'; ?>
                                            </td>
                                            <td>
                                                <a href="application-details.php?id=<?php echo $userData['id']; ?>" class="btn-action btn-view">
