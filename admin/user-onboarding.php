...
if (!$userSignedUp || !$userEmail) {
    header('Location: /admin/user-signup.php');
    exit();
}
...
<head>
    ...
    <title>Staff Onboarding - Logan Express Care</title>
...
<body>
    ...
    <!-- Page Header Start -->
    <div class="page-header bg-section mt-2">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <!-- Page Header Box Start -->
                    <div class="page-header-box">
                        <h1 class="text-anime-style-2" data-cursor="-opaque">Complete Your <span>Onboarding</span></h1>
                        <nav class="wow fadeInUp">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="../">home</a></li>
                                <li class="breadcrumb-item"><a href="user-signup.php">sign up</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="staff-onboarding-form-wrapper wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <?php if ($userData && $userData['status'] === 'submitted'): ?>
                            <div class="form-submitted-message">
                                <div class="success-icon">
                                    <i class="fas fa-check-circle"></i>
                                </div>
                                <h3>Form Already Submitted</h3>
                                <p>Your onboarding form has been submitted and is under review. Our HR team will contact you soon.</p>
                                <a href="../contact.php" class="btn-default">Contact HR Team</a>
                            </div>
                        <?php else: ?>
                            ...
                            <div class="form-step active" id="step-1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 mb-4">
                                        <input type="text" name="first_name" class="form-control" id="first_name" placeholder="First Name *" required value="<?php echo htmlspecialchars($userData['first_name'] ?? ''); ?>" readonly>
                                        <div class="help-block with-errors"></div>
                                    </div>

                                    <div class="form-group col-md-6 mb-4">
                                        <input type="text" name="last_name" class="form-control" id="last_name" placeholder="Last Name *" required value="<?php echo htmlspecialchars($userData['last_name'] ?? ''); ?>" readonly>
                                        <div class="help-block with-errors"></div>
                                    </div>

                                    <div class="form-group col-md-6 mb-4">
                                        <input type="email" name="email" class="form-control" id="email" placeholder="Email Address *" required value="<?php echo htmlspecialchars($userData['email'] ?? ''); ?>" readonly>
                                        <div class="help-block with-errors"></div>
                                    </div>

                                    <div class="form-group col-md-6 mb-4">
                                        <input type="text" name="phone" class="form-control" id="phone" placeholder="Phone Number *" required value="<?php echo htmlspecialchars($userData['phone'] ?? ''); ?>" readonly>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 mb-4">
                                        <select name="position" class="form-control form-select" id="position" required>
                                            ...
                                            <option value="disability_support_worker" <?php echo ($userData && $userData['position'] === 'disability_support_worker') ? 'selected' : ''; ?>>Disability Support Worker</option>
                                            <option value="nurse" <?php echo ($userData && $userData['position'] === 'nurse') ? 'selected' : ''; ?>>Nurse</option>
                                            <option value="other" <?php echo ($userData && $userData['position'] === 'other') ? 'selected' : ''; ?>>Other</option>
                                        </select>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 mb-4">
                                        <select name="employment_type" class="form-control form-select" id="employment_type" required>
                                            ...
                                            <option value="permanent" <?php echo ($userData && $userData['employment_type'] === 'permanent') ? 'selected' : ''; ?>>Permanent</option>
                                            <option value="casual" <?php echo ($userData && $userData['employment_type'] === 'casual') ? 'selected' : ''; ?>>Casual</option>
                                            <option value="contractor" <?php echo ($userData && $userData['employment_type'] === 'contractor') ? 'selected' : ''; ?>>Contractor</option>
                                        </select>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-3 mb-4">
                                        <input type="date" name="children_check_expiry" class="form-control" id="children_check_expiry" placeholder="Expiry Date" required value="<?php echo $userData['children_check_expiry'] ?? ''; ?>">
                                    ...
                                    <div class="form-group col-lg-3 mb-4">
                                        <input type="date" name="meals_certificate_expiry" class="form-control" id="meals_certificate_expiry" required value="<?php echo $userData['meals_certificate_expiry'] ?? ''; ?>">
                                        <small class="form-text">Expiry Date *</small>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-3 mb-4">
                                        <input type="date" name="ipc_certificate_expiry" class="form-control" id="ipc_certificate_expiry" required value="<?php echo $userData['ipc_certificate_expiry'] ?? ''; ?>">
                                        <small class="form-text">Expiry Date *</small>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-3 mb-4">
                                        <input type="date" name="first_aid_expiry" class="form-control" id="first_aid_expiry" required value="<?php echo $userData['first_aid_expiry'] ?? ''; ?>">
                                    ...
                                    <div class="form-group col-lg-3 mb-4">
                                        <input type="date" name="cpr_expiry" class="form-control" id="cpr_expiry" required value="<?php echo $userData['cpr_expiry'] ?? ''; ?>">
                                    ...
                                    <div class="form-group col-lg-3 mb-4">
                                        <input type="date" name="police_check_expiry" class="form-control" id="police_check_expiry" required value="<?php echo $userData['police_check_expiry'] ?? ''; ?>">
                                        <small class="form-text">Expiry Date *</small>
                                        <div class="help-block with-errors"></div>
                                    </div>
                            ...
                            <div class="form-step" id="step-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 mb-4" id="abn-field" style="display: none;">
                                        <input type="text" name="abn" class="form-control" id="abn" placeholder="ABN Number" value="<?php echo htmlspecialchars($userData['abn'] ?? ''); ?>">
                                        <div class="help-block with-errors"></div>
                                    </div>

                                    <div class="form-group col-md-6 mb-4" id="business-name-field" style="display: none;">
                                        <input type="text" name="business_name" class="form-control" id="business_name" placeholder="Business Name" value="<?php echo htmlspecialchars($userData['business_name'] ?? ''); ?>">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                        ...
                                        <div class="acknowledgment-list">
                                            ...
                                            <div class="acknowledgment-item">
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" name="ack_staff_details" id="ack_staff_details" required <?php echo ($userData && $userData['ack_staff_details']) ? 'checked' : ''; ?>>
                                            ...
                                            <div class="acknowledgment-item">
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" name="ack_induction" id="ack_induction" required <?php echo ($userData && $userData['ack_induction']) ? 'checked' : ''; ?>>
                                            ...
                                            <div class="acknowledgment-item">
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" name="ack_code_conduct" id="ack_code_conduct" required <?php echo ($userData && $userData['ack_code_conduct']) ? 'checked' : ''; ?>>
                                            ...
                                            <div class="acknowledgment-item">
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" name="ack_training_tracker" id="ack_training_tracker" required <?php echo ($userData && $userData['ack_training_tracker']) ? 'checked' : ''; ?>>
                                            ...
                                            <div class="acknowledgment-item">
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" name="ack_handbook" id="ack_handbook" required <?php echo ($userData && $userData['ack_handbook']) ? 'checked' : ''; ?>>
                                            ...
                                            <div class="acknowledgment-item">
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" name="ack_tax_declaration" id="ack_tax_declaration" required <?php echo ($userData && $userData['ack_tax_declaration']) ? 'checked' : ''; ?>>
                                            ...
                                            <div class="acknowledgment-item">
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" name="ack_bank_details" id="ack_bank_details" required <?php echo ($userData && $userData['ack_bank_details']) ? 'checked' : ''; ?>>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="review-section">
                                            ...
                                            <div class="final-consent">
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" name="final_consent" id="final_consent" required <?php echo ($userData && $userData['final_consent']) ? 'checked' : ''; ?>>
    ...
    <style>
        ...
        .form-submitted-message .success-icon {
            width: 100px;
            height: 100px;
            background: var(--accent-color);
            border-radius: 50%;
        ...
        .form-submitted-message .success-icon i {
            font-size: 48px;
            color: var(--white-color);
        }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                const formFields = [
                    'first_name', 'last_name', 'email', 'phone', 'position', 'employment_type',
                    'children_check_expiry', 'meals_certificate_expiry', 'ipc_certificate_expiry',
                    'first_aid_expiry', 'cpr_expiry', 'police_check_expiry', 'abn', 'business_name'
                ];
                ...
                fileFields.forEach(fieldName => {
                    ...
                    if (fileInput && fileInput.files && fileInput.files.length > 0) {
                        formData.append(fieldName, fileInput.files[0], fileInput.files[0].name);
                    }
                });
                ...
                // Submit to external Laravel API endpoint (newstore for existing users)
                ...
                .catch(error => {
                    ...
                    if (error.name === 'TypeError' && error.message.includes('CORS')) {
                        alert('CORS Error: The API server needs to allow requests from this domain. Please contact the backend team to add CORS headers.');
