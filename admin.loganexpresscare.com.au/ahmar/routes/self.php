...
// Staff Onboarding Routes (Admin View) - Outside the Self namespace group
ApiRoute::group(['prefix' => 'self', 'middleware' => ['api.auth.check', 'license-expire']], function () {
    ApiRoute::get('staff-onboarding', ['as' => 'api.self.staff-onboarding.index', 'uses' => 'App\Http\Controllers\Api\StaffOnboardingController@index']);
    ApiRoute::get('staff-onboarding/statistics', ['as' => 'api.self.staff-onboarding.statistics', 'uses' => 'App\Http\Controllers\Api\StaffOnboardingController@statistics']);
    ApiRoute::get('staff-onboarding/{id}/document/{documentType}', ['as' => 'api.self.staff-onboarding.download-document', 'uses' => 'App\Http\Controllers\Api\StaffOnboardingController@downloadDocument']);
    ApiRoute::get('staff-onboarding/{id}', ['as' => 'api.self.staff-onboarding.show', 'uses' => 'App\Http\Controllers\Api\StaffOnboardingController@show']);
    ApiRoute::put('staff-onboarding/{id}/status', ['as' => 'api.self.staff-onboarding.update-status', 'uses' => 'App\Http\Controllers\Api\StaffOnboardingController@updateStatus']);
    ApiRoute::delete('staff-onboarding/{id}', ['as' => 'api.self.staff-onboarding.destroy', 'uses' => 'App\Http\Controllers\Api\StaffOnboardingController@destroy']);
    ApiRoute::post('staff-onboarding/bulk-update', ['as' => 'api.self.staff-onboarding.bulk-update', 'uses' => 'App\Http\Controllers\Api\StaffOnboardingController@bulkUpdateStatus']);
});
