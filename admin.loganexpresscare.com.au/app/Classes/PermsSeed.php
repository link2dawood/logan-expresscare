...
class PermsSeed
{
    public static $mainPermissionsArray = [
        ...
        'staff_onboarding_view' => [
            'name' => 'staff_onboarding_view',
            'display_name' => 'Staff Onboarding View'
        ],
        'staff_onboarding_create' => [
            'name' => 'staff_onboarding_create',
            'display_name' => 'Staff Onboarding Create'
        ],
        'staff_onboarding_edit' => [
            'name' => 'staff_onboarding_edit',
            'display_name' => 'Staff Onboarding Edit'
        ],
        'staff_onboarding_delete' => [
            'name' => 'staff_onboarding_delete',
            'display_name' => 'Staff Onboarding Delete'
        ],
